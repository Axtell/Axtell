...
def get_answer(answer_id):
    ...
    try:
        ...
        return abort(404)
    return redirect(url_for('get_post', post_id=answer.post_id, answer_id=answer.id, p=page), code=301)
...
def get_post(post_id, title=None):
    ...
    if title != slug and request.args.get('noredirect', '0') != '1':
        ...
        canonical_url = url_for('get_post', post_id=post_id, answer_id=answer_id, title=slug, noredirect=1)
