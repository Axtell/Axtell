...
def do_post_vote(post_id, vote):
    ...
    return render_json({"success": True, "vote": vote, "total": get_post_vote_sum(post_id)})
...
def do_answer_vote(answer_id, vote):
    ...
    return render_json({"success": True, "vote": vote, "total": get_answer_vote_sum(answer_id)})
